...
def push_report(user_id, task, course_name, failed=False):
    if course_name.startswith("cpp-spring"):
    ...
    elif course_name.startswith("cpp-fall-nn"):
        url = "https://cpp0-nn.manytask.org/api/report"
        ...
        url = "https://app.manytask.org/api/db1-2025-fall/report"
    elif course_name.startswith("db2"):
        url = "https://app.manytask.org/api/db2-2026-spring/report"
    elif course_name.startswith("db"):
        url = "https://db.manytask.org/api/report"
    elif course_name.startswith("sre"):
        url = "https://app.manytask.org/api/sre-2025-fall/report"
